...
/*   Updated: 2019/07/09 18:05:08 by zfaria           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		save_image(t_rt *rt)
{
	...
	img.fp = fopen("rt_screenshot.png", "wb");
	png_init_io(img.png, img.fp);
	png_set_IHDR(img.png, img.info, WID, HEI, 8, PNG_COLOR_TYPE_RGB, PNG_INTERLACE_NONE,
		PNG_COMPRESSION_TYPE_BASE, PNG_FILTER_TYPE_BASE);
	img.palette = png_malloc(img.png, PNG_MAX_PALETTE_LENGTH * sizeof(png_color));
	png_set_PLTE(img.png, img.info, img.palette, PNG_MAX_PALETTE_LENGTH);
